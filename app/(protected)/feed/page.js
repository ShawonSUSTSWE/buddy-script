    ...
    return (
      <div className="_layout _layout_main_wrapper">
        <div className="_main_layout">
          <Navbar />
          <div className="container _custom_container" style={{ paddingTop: "40px" }}>
            <div className="row justify-content-center">
              <div className="col-xl-6 col-lg-8 col-md-12">
                <div style={{ textAlign: "center", padding: "60px 0" }}>
                  ...
                  <p style={{ marginTop: "16px", color: "#999" }}>Loading feed...</p>
                </div>
              </div>
            </div>
          </div>
                ...
                <div className="_layout_right_sidebar_wrap">
                  <div className="_layout_right_sidebar_inner">
                    <div className="_right_inner_area _b_radious6 _padd_t24 _padd_b24 _padd_r24 _padd_l24 _feed_inner_area">
                      <div className="_right_inner_area_content" style={{ textAlign: "center" }}>
                        <img
                        ...
                        />
                        <h5 style={{ fontWeight: 600, fontSize: "15px", marginBottom: "4px" }}>
                          {session?.user?.firstName} {session?.user?.lastName}
                        </h5>
                        <p style={{ fontSize: "13px", color: "#999" }}>{session?.user?.email}</p>
                      </div>
                    </div>
                  </div>
                </div>
