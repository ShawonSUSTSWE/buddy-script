        ...
        >
          ...
          >
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "16px" }}>
              ...
              <button onClick={() => setShowLikers(false)} style={{ background: "none", border: "none", fontSize: "18px", cursor: "pointer" }}>×</button>
            </div>
            {likers.map((liker) => (
              <div key={liker.id} style={{ display: "flex", alignItems: "center", gap: "10px", padding: "8px 0" }}>
                <img
